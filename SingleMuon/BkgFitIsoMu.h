...
void BkgFitIsoMu (const string& file, int nbin=160, double xmin=70, double xmax=150 , 
   ...
   // RooRealVar IsoMu_coef2( "IsoMu_coef2", "IsoMu_coef2"  , 2.92647e-05,  -0.001,  0.01, "Gev/c^{2}^-2" );
    RooRealVar IsoMu_coef1( "IsoMu_coef1", "IsoMu_coef1"  , -1, 1, "Gev/c^{2}^-1" );
    RooRealVar IsoMu_coef2( "IsoMu_coef2", "IsoMu_coef2"  , -1, 1, "Gev/c^{2}^-2" );
    ...
    h_frame->SetTitle("Background Distribution Fit :: IsoMu");
