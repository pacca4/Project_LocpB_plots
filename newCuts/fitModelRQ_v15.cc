...
//variabili per i bkg, decadimenti a destra->R e Q e a sinistra -> L
  ...
  RooRealVar RBkgComb ("RBkgComb", "combinatorial Bkg life, Right side" , 0.0399, 0.0, 0.5, "cm");
  RooRealVar LBkgComb ("LBkgComb", "combinatorial Bkg life, Left side"  , 0.0052, 0.0, 0.5, "cm");
  RooRealVar QBkgComb ("QBkgComb", "combinatorial Bkg life, Q tail side", 0.0027, 0.0, 0.5, "cm");
  ...
  RooRealVar Resolution( "Resolution","Distance Resolution", 0.00169, 0.00001,  0.1, "cm" );
  ...
  RooRealVar BFrac( "BFrac", "Bkg fraction"       , 0.59, 0.0, 1.0, "." );
  RooRealVar QFrac( "QFrac", "Bkg fraction q tail", 0.63, 0.0, 1.0, "." );
  RooRealVar RFrac( "RFrac", "Bkg fraction right ", 0.32, 0.0, 1.0, "." );
...
/* ***************
 ...
 // RBkgExpo.fitTo( *TempDist2, Range("highMass, lowMass, highDist"), Extended( kFALSE ));
...
TCanvas* t4d = new TCanvas( "t4d", outname.c_str(), 800, 600 );
  ...
  */
   ...
   //ModelRQ.plotOn(dframe, Components( "Signal"   ),LineStyle( kDashed ), LineColor( kOrange ) );
  ...
  */
   ...
   ModelRQ.plotOn( dframe, LineColor( kGreen ) );
...
//questi sono tutti insieme
  TString names[] = {
    "h_dataset",
    "ModelRQ_Int[m]_Norm[d,m]_Comp[CoreGauss]",
    "ModelRQ_Int[m]_Norm[d,m]_Comp[RBkgExpo]",
    "ModelRQ_Int[m]_Norm[d,m]_Comp[LBkgExpo]",
    "ModelRQ_Int[m]_Norm[d,m]_Comp[QBkgExpo]",
  ...
  TLegend* leg = new TLegend(0.6,0.9,0.60,0.90);
  Int_t i=-1;
  while ( names[++i] != "" ) {
