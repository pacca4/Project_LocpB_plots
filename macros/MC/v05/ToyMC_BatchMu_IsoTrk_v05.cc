...
void ToyMC_BatchMu_IsoTrk_v05(Int_t nsamples=1000, Int_t nbins=100, Int_t nev=100000, Double_t mu=1.0) {

	RooMsgService::instance().setSilentMode(true);
	RooMsgService::instance().setGlobalKillBelow(RooFit::WARNING);
	RooMsgService::instance().setGlobalKillBelow(RooFit::FATAL);

	ofstream ofile(Form("../../../macros/MC/sampling_tests/v05/BatchMu/IsoTrk/ToyMC_BatchMu_IsoTrk__nsamples_%d__nbins_%d__nev_%d__mu_%1.1f.txt", nsamples, nbins, nev, mu));
