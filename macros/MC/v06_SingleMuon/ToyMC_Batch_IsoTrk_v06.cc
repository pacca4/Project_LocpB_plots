...
void ToyMC_Batch_IsoTrk_v06(Int_t batch_id, Int_t nsamples=1000, Int_t nbins=100, Int_t nev=500000, Double_t mu=1.0) {

	RooMsgService::instance().setSilentMode(true);
	RooMsgService::instance().setGlobalKillBelow(RooFit::WARNING);
	RooMsgService::instance().setGlobalKillBelow(RooFit::FATAL);

	ofstream ofile(Form("../../../macros/MC/sampling_tests/v06/Batch/SingleMuon/ToyMC_Batch_IsoTrk__nsamples_%d__nbins_%d__nev_%d__mu_%1.1f__%d.txt", nsamples, nbins, nev, mu, batch_id));
