...
#fname=["dcap://t2-srm-02.lnl.infn.it/pnfs/lnl.infn.it/data/cms//store/mc/RunIISummer16NanoAODv5/HToJPsiG_ToMuMuG_allProdMode_M125_TuneCUETP8M1_13TeV_Pythia8/NANOAODSIM/PUMoriond17_Nano1June2019_102X_mcRun2_asymptotic_v7-v1/30000/9FAC98DC-0904-4546-B6F8-2B066C445281.root"]
fname=["/lustre/cmswork/aavalent/CMSSW_10_2_6/src/PhysicsTools/NanoAODTools/python/postprocessing/mumu_analysis/Signal_Skim.root"]
#fname=["/lustre/cmswork/aavalent/CMSSW_10_2_6/src/PhysicsTools/NanoAODTools/python/postprocessing/mumu_analysis/FF500739-DA8C-7D43-8428-CB6C355BA13F_Skim.root"]
...
preselection=None
p=PostProcessor(outputDir=".", inputFiles=fname, cut=preselection, 
            branchsel=None, modules=[MuMuGModuleConstr()],#MuMuGProducer ()], ()
            jsonInput=jsonFile, histFileName=None, histDirName=None, 
            outputbranchsel="keep_and_drop_Selector.txt", maxEntries=long(options.maxEntries))
