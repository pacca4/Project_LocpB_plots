...
void DrawAngularCanvas( const string& data_file,  const string& mc_file, const string& tree, 
    ...
    gStyle->SetLineScalePS(1);
    c->Print((outname+tree+feature+".pdf").c_str());
    c->Print((outname+tree+feature+".png").c_str());                	
}
...
void AngularDrawIsoMu(const string& data_file,  const string& mc_file){
	DrawAngularCanvas(data_file, mc_file, "Events_IsoMu" , "DeltaR"    ,"","Final");
	DrawAngularCanvas(data_file, mc_file, "Events_IsoMu" , "DeltaRCM"  ,"","Final");
	DrawAngularCanvas(data_file, mc_file, "Events_IsoMu" , "DeltaPhiCM","","Final");
	DrawAngularCanvas(data_file, mc_file, "Events_IsoMu" , "AngleCM"   ,"","Final");

}


void AngularDrawIsoTrk(const string& data_file,  const string& mc_file){
	DrawAngularCanvas(data_file, mc_file, "Events_IsoTrk" , "DeltaR"    ,"","Final");
	DrawAngularCanvas(data_file, mc_file, "Events_IsoTrk" , "DeltaRCM"  ,"","Final");
	DrawAngularCanvas(data_file, mc_file, "Events_IsoTrk" , "DeltaPhiCM","","Final");
	DrawAngularCanvas(data_file, mc_file, "Events_IsoTrk" , "AngleCM"   ,"","Final");
