...
USAGE="
$(basename "$0") [-h] \$1 \$2 \$3 \$4 \$5 -- bash script to launch ToyMC_Batch_IsoMu_v05 bjobs to LSF
...
/bin/cat <<EOM > $AUXFILE
#BSUB -J ToyMC_Batch_IsoMu_v05
cd ..
root -l -b -q '../../../macros/MC/v05/ToyMC_Batch_IsoMu_v05.cc('$i', '$2', '$3', '$4', '$5');'
EOM
